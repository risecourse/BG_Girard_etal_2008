...
# Running the Model
Either open a terminal and type "python CBGTC.py" or open Spyder and run the CBGTC.py file.

# Expected Results
The program will simulate the contracting basal ganglia model (CBG) in three tests: 
