...
class BasalGanglia:
  #-----------------------------------------
  def __init__(self,model,NbChannels,opt_params=[],simname = None):
    ...
    self.f=open('log/' + titleadd + 'BG_'+model,'w')    # log file where the internal state will be stored if logAll function is used
